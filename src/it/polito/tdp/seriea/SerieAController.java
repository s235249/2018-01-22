...
public class SerieAController {
    ...
    void doSelezionaSquadra(ActionEvent event) {
    	...
    	String risultato= model.getSeasonEPunteggi(t);
    ...
    void doTrovaAnnataOro(ActionEvent event) {
    	...
    	AnnoPunteggio annatadoro= model.creaGrafo();
    	
    	txtResult.appendText("L'annata migliore è "+ annatadoro.getS().getDescription()+ " con "+ annatadoro.getPunteggio()+" punti\n");
	...
	public void setModel(Model model) {
		...
		this.model=model;
		boxSquadra.getItems().addAll(model.getListTeam());
	}
}
